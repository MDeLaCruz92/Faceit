...
class FaceView: UIView {
    ...
    @IBInspectable // 1.0 is smiley, -1.0 is frowny
    ...
    private func centerOfEye(_ eye: Eye) -> CGPoint {  // took out from pathForEye for 13th lecture
    ...
    private lazy var rightEye: EyeView = self.createEye() // a way to get around from init
